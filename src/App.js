      ...
      <div id='portfolio' className=''>
        ...
        <div className="container ">
          <div className='row justify-content-around'>
            ...
            <PortfolioContent portfolioImage={slack} portfolioImageAlt='slack-clone-website' portfolioTitle='Clone Website' portfolioDesc='Cloning a webpage of Slack' category='Personal Project' portfolioLink='https://main.d1zza598wt88g8.amplifyapp.com/' />
